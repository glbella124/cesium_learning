...
GeometryUtils.isGeometry3js = function (geometry) {
    return typeof THREE !== 'undefined' && geometry instanceof THREE.BoxGeometry || geometry.attributes && geometry.attributes.position && geometry.index || geometry.vertices && geometry.faces;
};
